                  ...
                  <div className="row">
                     ...
                     <div
                        ...
                        <div className="achievement-card mt-30">
                           ...
                           <h5>
                              Más de 28 años de experiencia en viajes especializados en bicicleta de montaña en Los
                              Andes.
                           </h5>
                        </div>
                     </div>
                     ...
                     >
                        <div className="achievement-card mt-30">
                           ...
                           <h5>
                              Contamos con Todos los Certificados y autorizaciones de operación del MINCETUR,
                              actualizados Pos Pandemia
                           </h5>
                        </div>
                     </div>
                  </div>
